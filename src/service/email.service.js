...
async function sendRegisterationEmail(userEmail , name) {
    const subject = 'Welcome to our secure banking system';
    const text = `Hello ${name} , /n/n ThankYou for registerating at Secure Banking System . `;
    const html = `<p>HELLO ${name} , </p> <p> Thank you for registering at secure bannking system </p>`
